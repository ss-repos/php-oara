	...
	public function getTransactionList($merchantList = null, \DateTime $dStartDate = null, \DateTime $dEndDate = null) {
		...
		if (!empty($response)) {
			...
			foreach($response as $raw_transaction) {
				...
				$transaction['commission'] = round((float) $raw_transaction->conversion_commission_total, 2);
				$transaction['amount'] = round((float) $raw_transaction->conversion_order_value, 2);
